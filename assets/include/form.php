...
$toemails = array(
	            'email' => 'info@childfreefoundation.org', // Your Email Address
				'name' => 'Hassan Kikabi' // Your Name
);
...
$fromemail = array(
				'email' => 'info@childfreefoundation.org', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'CHILDFREE FOUNDATION UGANDA' // Company Name
			);
